...
import { 
  ...
  RotateCcw, TrendingDown, Database, Globe, Percent
} from 'lucide-react';
import { 
    ...
    <div className="space-y-6 animate-in fade-in duration-300 pb-12 font-sans">
      ...
      <div className="bg-white rounded-2xl border border-gray-200 p-6 shadow-xs flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4">
        ...
        <div className="flex items-center gap-2.5 flex-wrap">
          ...
          <Button 
            ...
            className="bg-indigo-600 hover:bg-indigo-700 text-white text-xs font-bold px-3.5 py-2 rounded-xl flex items-center gap-1.5 shadow-xs cursor-pointer"
          >
        ...
        <div className="bg-white rounded-2xl border-2 border-vna-blue/30 p-5 shadow-sm space-y-4 animate-in slide-in-from-top duration-200">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 border-b border-gray-100 pb-3">
            ...
            <div className="flex items-center gap-2 flex-wrap">
              ...
              >
                <TrendingDown, Database, Globe, Percent size={12} /> Giá thấp (-20%)
              </button>
              <button 
          ...
          <div>
            <div className="flex items-center gap-2">
              ...
              <h3 className="text-sm sm:text-base font-black text-vna-navy uppercase tracking-wide">
                Kịch bản Phân bổ Lô SAF & Cơ chế Kê khai (SAF Allocation & Claim)
              </h3>
            </div>
                  ...
                  return (
                    <div className="space-y-2">
                      ...
                      <div className="w-full h-3 bg-gray-200 rounded-full overflow-hidden flex">
                        <div style={{ width:  }} className="bg-[#006885] transition-all duration-300" title={} />
                        <div style={{ width:  }} className="bg-[#4f46e5] transition-all duration-300" title={} />
                        <div style={{ width:  }} className="bg-[#10b981] transition-all duration-300" title={} />
                      </div>
      ...
      {isCompareModalOpen && (
        <div className="fixed inset-0 bg-black/60 backdrop-blur-xs z-50 flex items-center justify-center p-3 sm:p-6 overflow-y-auto animate-in fade-in duration-200">
          <div className="bg-white rounded-3xl border border-gray-200 shadow-2xl w-full max-w-6xl max-h-[90vh] flex flex-col overflow-hidden relative animate-in zoom-in-95 duration-200">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="text-base font-black text-vna-navy">
                    So sánh Các Phương án Phân bổ & Chi phí Tiết kiệm
                  </h3>
                  <p className="text-xs text-gray-500">
                    Đối chiếu chi phí mua hạn ngạch đền bù giữa các kịch bản phân bổ SAF (EU ETS, UK ETS, CORSIA)
                  </p>
                </div>
              </div>
            ...
            <div className="p-4 border-t border-gray-100 bg-gray-50/50 flex items-center justify-between">
              <span className="text-xs text-gray-500 italic">
                * Bấm &quot;Áp dụng phương án này&quot; trên từng thẻ để cập nhật trực tiếp kịch bản phân bổ.
              </span>
              <Button 
                onClick={() => setIsCompareModalOpen(false)} 

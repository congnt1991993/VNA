...
output_dir = "/Users/congnguyen/Library/CloudStorage/OneDrive-Personal/Work/04. Company/Synodus/GOV/01.VNA/VNA/scratch/appendix_texts"

os.makedirs(output_dir, exist_ok=True)

# Find all docx files in appendix directory (excluding zip and hidden files)
docx_files = glob.glob(os.path.join(appendix_dir, "*.docx"))
print(f"Found {len(docx_files)} appendix docx files.")
